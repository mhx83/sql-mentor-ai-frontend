            ...
            {assignments.map((assignment: any) => (
              <ul className="wd-assignments list-group rounded-0">
                ...
                <div className="d-flex align-items-center">
                  ...
                  | <strong> Not Available until</strong> {formatDate(assignment.availableFrom)} at 12:00am | </ul>
                  <ul className="wd-assignment-description"> <strong>Due </strong> {formatDate(assignment.due)} at 11:59pm |&nbsp;
